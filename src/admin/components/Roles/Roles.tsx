...
export const Roles = () => {
  ...
  const { roles, handleCreate, handleUpdate, handleDelete } =
    useRolesDataGrid();
  ...
  const roleCard = (rowData: IRole) => (
    <div key={rowData.role_id} className="admin-mobile-card p-3 mb-3">
  ...
  return (
    <MainLayout>
      ...
      >
        <div className="field">
          <div className="field">
            <label htmlFor="role_nm" className="font-bold">
              Nombre
            </label>
            <InputText
              id="role_nm"
              value={role.role_nm}
              onChange={(e) => onInputChange(e, "role_nm")}
              required
              autoFocus
              className={classNames({
                "p-invalid": submitted && !role.role_nm,
              })}
            />
            {submitted && !role.role_nm && (
          ...
          <div className="field flex gap-2 align-items-center">
            <Checkbox
              ...
              onChange={(e) => setRole({ ...role, is_active: e.checked })}
            />
